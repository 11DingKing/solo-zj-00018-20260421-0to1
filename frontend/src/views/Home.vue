        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="category-list">
              ...
              >
                <span>{{ cat.name }}</span>
                <span class="text-xs text-secondary">({{ cat.postCount || 0 }})</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <main class="main-section">
        <div class="card mb-4">
          <div class="card-body flex items-center justify-between">
            ...
            <router-link v-if="userStore.isLoggedIn" to="/new-post" class="btn btn-primary">
              发帖
            </router-link>
          </div>
        </div>
        ...
        <div v-else>
          <div v-for="post in posts" :key="post._id" class="card post-card mb-2">
            <div class="card-body">
              ...
              <div class="post-meta flex items-center gap-4 text-sm text-secondary">
                <span>
